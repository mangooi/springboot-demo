package club.mangooi.springboot.demo.enums;

import club.mangooi.springboot.demo.exception.*;
...
public enum ExceptionEnum {
    ...
    public static ExceptionEnum getByHttpStatus(@NonNull HttpStatus httpStatus) {
    ...
    public static ExceptionEnum getByEClass(@NonNull Class<? extends BusinessException> eClass) {
        for (ExceptionEnum exceptionEnum : ExceptionEnum.values()) {
